...
const dispatchTypes = {toggle: 'toggle', reset: 'reset'}
...
function useToggle({initialOn = false, reducer = toggleReducer} = {}) {
  ...
  const toggle = () => dispatch({type: dispatchTypes.toggle})
  const reset = () => dispatch({type: dispatchTypes.reset, initialState})
